...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(event)
    ...
    vim.keymap.set('n', 'gDh', function() vim.cmd("split"); vim.lsp.buf.definition() end, opts)
    vim.keymap.set('n', 'gDv', function() vim.cmd("vsplit"); vim.lsp.buf.definition() end, opts)
